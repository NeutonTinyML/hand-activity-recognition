...
static neuton_f32_t skewness_variance_f32_(const neuton_f32_t* p_input, 
                                            neuton_u16_t num, 
...
static neuton_f32_t skewness_variance_f32_s_(const neuton_f32_t* p_input,
...
static neuton_f32_t skewness_f32_s_(const neuton_f32_t* p_input,
                                    neuton_u16_t num, size_t stride,
                                    const neuton_f32_t mean,
...
static neuton_f32_t skewness_f32_(const neuton_f32_t* p_input,
                                neuton_u16_t num, const neuton_f32_t mean,
                                const neuton_f32_t var)
{
    NEUTON_DSP_RETURN_IF(var == 0, NEUTON_DSP_ZERO_DIV_FLAG);
                                ...
                                neuton_dsp_stat_ctx_f32_t* p_ctx)
{
    ...
    case NEUTON_DSP_STAT_CTX_EMPTY:
        ...
        skew = skewness_variance_f32_(p_input, num, p_ctx, mean);
        break;
    case NEUTON_DSP_STAT_CTX_SUM_VAR_FLAGS:
        mean = p_ctx->value.sum / num;
        skew = skewness_f32_(p_input, num, mean, p_ctx->value.var);
        break;
                                    ...
                                    size_t stride, neuton_dsp_stat_ctx_f32_t* p_ctx)
{
    ...
    case NEUTON_DSP_STAT_CTX_EMPTY:
        ...
        skew = skewness_variance_f32_s_(p_input, num, stride, p_ctx, mean);
        break;
    case NEUTON_DSP_STAT_CTX_SUM_VAR_FLAGS:
        mean = p_ctx->value.sum / num;
        skew = skewness_f32_s_(p_input, num, stride, mean, p_ctx->value.var);
        break;
    case NEUTON_DSP_STAT_CTX_SUM_FLAG:
        mean = p_ctx->value.sum / num;
        skew = skewness_variance_f32_s_(p_input, num, stride, p_ctx, mean);
